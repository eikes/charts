Gem::Specification.new do |s|
  ...
  s.files       = [
                    ...
                    'lib/graph_tool/legend.rb',
                    'lib/graph_tool/bar_chart/grid/grid.rb',
                    'lib/graph_tool/bar_chart/grid/grid_line.rb',
                    'lib/graph_tool/bar_chart/grid/vertical_grid_line.rb',
                    'lib/graph_tool/bar_chart/grid/horizontal_grid_line.rb',
                    'lib/graph_tool/bar_chart/bar_chart.rb',
                    'lib/graph_tool/bar_chart/bar/bar.rb',
                    'lib/graph_tool/bar_chart/bar/vertical_bar.rb',
                    'lib/graph_tool/bar_chart/bar/horizontal_bar.rb',
                    'lib/graph_tool/pie_chart/pie_chart.rb',
